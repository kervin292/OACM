...
from utils.DPAI_utils import context_mask, mix_loss, update_ema_variables, adjust_roi_parameters,compute_roi_parameters,apply_updated_roi_parameters
...
if __name__ == "__main__":
    ...
    pre_snapshot_path = "./predict/DPAI/LA_{}_{}_labeled/pre_train/best_model.pth".format(args.exp, args.labelnum)
    self_snapshot_path = "./predict/DPAI/LA_{}_{}_labeled/self_train/best_model.pth".format(args.exp, args.labelnum)

    print("Starting DPAI training.")
